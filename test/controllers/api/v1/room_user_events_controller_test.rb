...
class Api::V1::RoomUserEventsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create api_v1_room_user_event" do
    assert_difference("Api::V1::RoomUserEvent.count") do
  ...
  test "should destroy api_v1_room_user_event" do
    assert_difference("Api::V1::RoomUserEvent.count", -1) do
