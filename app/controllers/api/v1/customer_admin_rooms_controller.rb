class Api::V1::CustomerAdminRoomsController < ApplicationController
  ...
  def index
    @api_v1_customer_admin_rooms = Api::V1::CustomerAdminRoom.all
  ...
  def create
    @api_v1_customer_admin_room = Api::V1::CustomerAdminRoom.new(api_v1_customer_admin_room_params)
  ...
  private
    ...
    def set_api_v1_customer_admin_room
      @api_v1_customer_admin_room = Api::V1::CustomerAdminRoom.find(params.expect(:id))
    end
