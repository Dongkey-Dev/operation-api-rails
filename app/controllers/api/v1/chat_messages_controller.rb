class Api::V1::ChatMessagesController < ApplicationController
  ...
  def index
    @api_v1_chat_messages = Api::V1::ChatMessage.all
  ...
  def create
    @api_v1_chat_message = Api::V1::ChatMessage.new(api_v1_chat_message_params)
  ...
  private
    ...
    def set_api_v1_chat_message
      @api_v1_chat_message = Api::V1::ChatMessage.find(params.expect(:id))
    end
